...
public class TeacherController {
    ...
    private String StudentList(HttpServletRequest request, HttpServletResponse response, Model model, Integer pageNum){
        ...
        Sort sort = Sort.by(Sort.Direction.ASC, "userid");  // 这里的"recordNo"是实体类的主键，记住一定要是实体类的属性，而不能是数据库的字段
...
//修改学生
    ...
    private String selectexam(Model model,Integer pageNum){
        ...
        Sort sort = Sort.by(Sort.Direction.ASC, "eid");  // 这里的"recordNo"是实体类的主键，记住一定要是实体类的属性，而不能是数据库的字段
  ...
  private String findAllScore(HttpServletRequest request,Integer pageNum,Model model){
        ...
        Sort sort = Sort.by(Sort.Direction.ASC, "seid");  // 这里的"recordNo"是实体类的主键，记住一定要是实体类的属性，而不能是数据库的字段
